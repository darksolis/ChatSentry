...
v1.4.2
- Fixed rapid-fire detection so repeat and burst counters both advance on every public message.
- Public flood protection now applies to friends and guildmates; explicit whitelist entries still bypass it.
